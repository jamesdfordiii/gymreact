...
const skillsData = [
  {
    ...
    link: "#",
    description: [
      "Unlimited access to the gym during staffed hours",
  ...
  },
  {
    ...
    description: [
      ...
      "Access to exclusive group fitness classes",
  ...
  },
  {
    ...
    description: [
      ...
      "Priority registration for special events and workshops",
      "Free guest passes (up to 4 per month)",
      "Complimentary towel service and locker rental",
      "VIP access to exclusive areas and equipment",
    ],
    duration: "12 months",
    aosDelay: "1000",
  },
